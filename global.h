namespace global {
    int W               = 0; // W of resized frame 
    int H               = 0; // H of resized frame
    int real_W          = 0; // The OG W of the frame
    int real_H          = 0; // The OG H of the frame
    int start_W         = 1660; // The start width of the minimap   ***EDIT***
